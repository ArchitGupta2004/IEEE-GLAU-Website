      ...
      <div className="container">
        ...
        <div className="about-main">
          ...
          <div className="about-vision">
            <h2>Our Vision</h2>
            <p>
              To be the premier hub for technological innovation and professional
              development at GLA University, inspiring students to make
              meaningful contributions to society through engineering excellence.
            </p>
